...
import 'package:mc_queen_cargo/features/Pages/CargoPriceCalculate/ParcelSending/package_sending_mixin.dart';
...
class PackageSendingDialog extends StatelessWidget {
  const PackageSendingDialog({super.key, required this.model, required this.icon});
