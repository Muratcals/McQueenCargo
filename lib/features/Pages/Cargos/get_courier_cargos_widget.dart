part of 'get_courier_cargos_page.dart';

class _CargosPageBody extends StatefulWidget {
  ...
  @override
  State<_CargosPageBody> createState() => _CargosPageBodyState();
}

class _CargosPageBodyState extends State<_CargosPageBody> {
  @override
  Widget build(BuildContext context) {
    return AtomicFutureBuilder(
      future: Future.wait([
        widget.service.getAllCargoInformation(tcNo: widget.tcNo),
        widget.service.getAllCourierList(tcNo: widget.tcNo)
      ]),
      child: (result) {
