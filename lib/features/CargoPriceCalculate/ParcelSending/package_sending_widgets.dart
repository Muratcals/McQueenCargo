...
import 'package:mc_queen_cargo/features/CargoPriceCalculate/ParcelSending/package_sending_mixin.dart';
...
class _PackageSendingPageWidgetsState extends State<PackageSendingPageWidgets>
            ...
            Container(
              ...
              child: Column(
                children: [
                  ...
                  packageInformationWidget(
                      networkIcon: "https://ozerhamza.com.tr/img/xl.jpeg",
                      parcelSize: "X-Large"),
            ...
            Container(
              ...
              child: Column(
                children: [
                  Container(
                    child: textWidget(
                        title: parcelSize.substring(0, 1),
                        fontsize: 20.sp,
                    ...
                    onTap: () {
                      dialog(
                        model: widget.model.lastWhere((element) =>
                            element.cargoParcelTypeName!.contains(parcelSize)),
                        icon: networkIcon,
                      );
                    },
                    child: Icon(
  ...
  void dialog({
    required CargoParcelTypeModel model,
