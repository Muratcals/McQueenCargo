...
class _PackageAdditionalServicesState extends State<PackageAdditionalServices> {
        ...
        children: [
          ...
          SingleChildScrollView(
            ...
            child: Row(
              children: [
                for (int i = 0;
                    i < controller.packageProcurementServices.length;
                    i++)
                  procurementServiceRowItems(
                      controller.packageProcurementServices[i], i)
              ],
            ),
          ),
          SizedBox(height: 5.h),
          ...
          SingleChildScrollView(
            ...
            child: Row(
              children: [
                for (int i = 0;
                    i < controller.packageDeliveryServices.length;
                    i++)
  ...
  InkWell procurementSelectedButtonController(int index) {
    return InkWell(
      onTap: () {
        double procurementPrice = controller
  ...
  InkWell deliverySelectedButtonController(int index) {
    return InkWell(
      onTap: () {
        double deliveryPrice = controller.packageDeliveryServices[index].price -
            controller.packageDeliveryServices[selectedDelivery].price;
