...
class _ContactInformationBody extends StatelessWidget {
  const _ContactInformationBody({required this.eMail, required this.onPressed});
...
class _EMailRepeatTextField extends StatelessWidget {
  const _EMailRepeatTextField({super.key, required this.eMail});
  final RxString eMail;
  @override
  Widget build(BuildContext context) {
...
class _EMailTextField extends StatelessWidget {
  const _EMailTextField({super.key, required this.eMail});
  final RxString eMail;
  @override
  Widget build(BuildContext context) {
