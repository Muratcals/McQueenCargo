...
import 'package:mc_queen_cargo/features/View/AddAddress/View/district_page.dart';
...
class _CreateAddressPageState extends State<CreateAddressPage>
  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
      providers: [
        BlocProvider(
          create: (context) => CustomerAddressController(),
        ),
        BlocProvider(
          create: (context) => NeighbourhoodController(),
        ),
        BlocProvider(
          create: (context) => ReceiverAddressController(),
        )
      ],
      child: SafeArea(
        child: Scaffold(
                  ...
                  child: Column(
                    children: [
                      ...
                      incoming.contains("receiver")
                          ...
                          : Container(),
                      BlocBuilder<CustomerAddressController, AddressModel>(
                          builder: (context, state) {
                        return BlocBuilder<ReceiverAddressController,ReceiverAddressModel>(
                          builder: (context,state) {
