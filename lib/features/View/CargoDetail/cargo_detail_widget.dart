part of '../CargoDetail/cargo_detail_page.dart';

class _CargoDetailDesign extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return AtomicFutureBuilder(
      future: Future.wait([
        service.getOneCargoInformation(cargoId: cargoId),
        service.getCargoMovements(cargoId: cargoId)
      ]),
      child: (model) {
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 5.h),
                _CargoDetailTabBar(
                    tabController: tabController, tabIndex: tabIndex),
